...
inline void Draw3dRect(CDC* pDC, CRect rect)
{
...
inline void Draw3dCorner(CDC* pDC, CRect rect, int borderWidth, COLORREF lightColor, COLORREF darkColor, bool isTop, bool isLeft)
{
